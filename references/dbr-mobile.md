...
Barcode and QR code scanning in mobile apps can use either **DCV** (`references/dcv.md`) or the lightweight **DBR** (`references/dbr.md`). Both share the same barcode engine.
